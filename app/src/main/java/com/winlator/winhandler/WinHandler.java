...
public class WinHandler {
    ...
    public void start() {
        try {
            ...
            String p1_mem_path = "/data/data/" + R.string.gamenative_home_storage_dir + "/files/imagefs/tmp/gamepad.mem";
            ...
            for (int i = 0; i < extraGamepadBuffers.length; i++) {
                String extra_mem_path = "/data/data/" + R.string.gamenative_home_storage_dir + "/files/imagefs/tmp/gamepad" + (i + 1) + ".mem";
